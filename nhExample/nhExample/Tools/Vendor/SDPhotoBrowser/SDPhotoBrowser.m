...
//    BOOL hasHighQImage = [manager diskImageExistsForURL:[self highQualityImageURLForIndex:self.currentImageIndex] completion:^(BOOL isInCache) {
//        
//    }];
...
//    CGRect rect = [self.sourceImagesContainerView convertRect:sourceView.frame toView:self];
    UIView *sourceView = self.currentImageView;
