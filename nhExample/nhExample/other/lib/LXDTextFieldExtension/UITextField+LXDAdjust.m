...
#define offsetHeight 35 //textfield偏离键盘的上方的间距
...
- (void)keyboardWillShow: (NSNotification *)notification
{
    if (self.isFirstResponder) {
        ...
        //1.设置xttexField偏移键盘上方的距离
        CGFloat overstep = actualHeight - CGRectGetHeight([UIScreen mainScreen].bounds) + offsetHeight;
        if (overstep > 0) {
